<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Signup_Modify_Dt.aspx.cs" Inherits="SmallManager.Signup_Modify_Dt" %>
            ...
            <div class="row">
                <div class="col-lg-12" style="padding-top: 20px;">
                    ...
                    <form class="form-horizontal col-md-6 col-md-offset-3">
                        ...
                        <div class="form-group">
                            <label for="" class="col-sm-3 control-label">付款方式</label>
                            <div class="col-sm-9">
        ...
        <div class="container" style="background: #e6f9ff;">
            <div class="row">
                ...
                <div class="col-lg-12" style="padding-top: 20px;">
                    ...
                    <div class="col-md-6 col-md-offset-3 text-center">
                        <button type="button" class="btn btn-primary" style="font-size: 16px; font-weight: bold;">修改</button>&nbsp;&nbsp;&nbsp;
                        <button type="button" class="btn btn-info" style="font-size: 16px; font-weight: bold;">取消</button>
                    </div>
                </div>
            </div>
        </div>
