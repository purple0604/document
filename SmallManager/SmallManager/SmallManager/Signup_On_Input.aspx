<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Signup_On_Input.aspx.cs" Inherits="SmallManager.Signup_On_Input" %>
                ...
                <div class="col-lg-12" style="padding-top: 20px; background: #e6f9ff;">
                    ...
                    <form class="form-horizontal col-md-6 col-md-offset-3">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="" placeholder="EX:0912345678">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="" class="col-sm-3 control-label"><span style="color: #C82729;">✶</span>E-mail</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="" placeholder="xxx@mail.com">
                            </div>
                        </div>
                        <div class="form-group">
            ...
            <div class="row">
                ...
                <div class="col-lg-12" style="padding-top: 20px;">
                    ...
                    <form class="form-horizontal col-md-6 col-md-offset-3">
                        <br>
                        <div class="form-group">
                            <label for="" class="col-sm-3 control-label"><span style="color: #C82729;">✶</span>小朋友姓名</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="" placeholder="">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="" class="col-sm-3 control-label"><span style="color: #C82729;">✶</span>小朋友生日</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="" placeholder="EX：2014/01/01">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="" class="col-sm-3 control-label"><span style="color: #C82729;">✶</span>小朋友制服尺寸</label>
                            <div class="col-sm-9">
                                <select class="form-control">
                                    <option>- 請選擇 -</option>
                                    <option>小(小店特S)</option>
                                    <option>中(小店特M)</option>
                                    <option>大(一般XS)</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-12 col-md-offset-3" style="padding-bottom: 15px;">
                            <img src="img/clothes_size.png" alt="" class="img_icon" /></div>
                    </form>
                </div>
                <!--小朋友1 END -->
                <!--小朋友2 資料輸入-->
                ...
                <div class="col-lg-12" style="padding-top: 20px;">
                    ...
                    <div class="col-md-6 col-md-offset-3 text-center">
                        <button type="button" class="btn btn-primary" style="font-size: 16px; font-weight: bold;">確定</button>
                    </div>
                </div>
                <!--小朋友3 END-->
            </div>
